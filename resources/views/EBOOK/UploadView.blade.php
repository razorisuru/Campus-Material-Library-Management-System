                                                    ...
                                                    <div class="form-check">
                                                        <div class="checkbox">
                                                            <input type="checkbox" id="category_{{ $ebookCategory->id }}"
                                                                ...
                                                                value="{{ $ebookCategory->id }}" {{-- {{ in_array($ebookCategory->id, $ebooks->categories->pluck('id')->toArray()) ? 'checked' : '' }} --}}>
                                                            <label
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div name="ebook_file"
                                                ...
                                                <div class="filepond--drop-label"
                                                    style="transform: translate3d(0px, 0px, 0px); opacity: 1;"><label
                                                        for="filepond--browser-52d8cf0i6"
                                                        id="filepond--drop-label-52d8cf0i6" aria-hidden="true">Drag &amp;
